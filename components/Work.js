...
const Experiance = () => {
 ...
 {/* eslint-disable no-alert, no-console */}
    ...
    <div className="p-4">
      ...
      <p className="text-white mb-4 text-md font-extralight">is a news and content platform that covers a wide range of topics such as current events, politics, sports, and lifestyle.</p>
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 px-2 gap-4">
      <a href="https://feed-news.netlify.app/" className="flex items-center text-purple-400 hover:underline">
        Go Live
      ...
      <a href="https://github.com/rotshidzw/peca" className="flex items-center text-purple-400 hover:underline">
        Git code
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M6 6a.75.75 0 01.75-.75h6.5a.75.75 0 01.75.75v6.5a.75.75 0 11-1.5 0V6.56L4.72 14.78a.75.75 0 11-1.06-1.06L11.44 6H6z" clipRule="evenodd" />
        </svg>
 ...
 {/* eslint-disable no-alert, no-console */}
    ...
    <div className="p-4">
      ...
      <p className="text-white mb-4 text-md font-extralight">The template also includes pages for services, pricing, and booking, as well</p>
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 px-2 gap-4">
      <a href="https://storied-sunburst-99dd6f.netlify.app/" className="flex items-center text-purple-400 hover:underline">
        Go Live
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M6 6a.75.75 0 01.75-.75h6.5a.75.75 0 01.75.75v6.5a.75.75 0 11-1.5 0V6.56L4.72 14.78a.75.75 0 11-1.06-1.06L11.44 6H6z" clipRule="evenodd" />
        </svg>
      ...
      <a href="https://github.com/rotshidzw/the-crystal-project" className="flex items-center text-purple-400 hover:underline">
        Git code
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M6 6a.75.75 0 01.75-.75h6.5a.75.75 0 01.75.75v6.5a.75.75 0 11-1.5 0V6.56L4.72 14.78a.75.75 0 11-1.06-1.06L11.44 6H6z" clipRule="evenodd" />
        </svg>
 ...
 {/* eslint-disable no-alert, no-console */}
    ...
    <div className="p-4">
      ...
      <p className="text-white mb-4 text-md font-extralight"> functionality for visitors who want to Go Live about the business</p>
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 px-2 gap-4">
      <a href="https://main--friendly-genie-e6ae39.netlify.app/" className="flex items-center text-purple-400 hover:underline">
        Go Live
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M6 6a.75.75 0 01.75-.75h6.5a.75.75 0 01.75.75v6.5a.75.75 0 11-1.5 0V6.56L4.72 14.78a.75.75 0 11-1.06-1.06L11.44 6H6z" clipRule="evenodd" />
        </svg>
      ...
      <a href="https://github.com/rotshidzw/product-landing-page" className="flex items-center text-purple-400 hover:underline">
        Git code
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M6 6a.75.75 0 01.75-.75h6.5a.75.75 0 01.75.75v6.5a.75.75 0 11-1.5 0V6.56L4.72 14.78a.75.75 0 11-1.06-1.06L11.44 6H6z" clipRule="evenodd" />
        </svg>
 ...
 {/* eslint-disable no-alert, no-console */}
    ...
    <div className="p-4">
      ...
      <a href="https://github.com/rotshidzw/space-travelers-hub/tree/main" className="flex items-center text-purple-400 hover:underline">
        Git code
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M6 6a.75.75 0 01.75-.75h6.5a.75.75 0 01.75.75v6.5a.75.75 0 11-1.5 0V6.56L4.72 14.78a.75.75 0 11-1.06-1.06L11.44 6H6z" clipRule="evenodd" />
        </svg>
 ...
 {/* eslint-disable no-alert, no-console */}
    ...
    <div className="p-4">
      ...
      <p className="text-white mb-4 text-md font-extralight">real state agent web page I’ve helped families determine their home’s worth, set the right price, and negotiate a winning deal.</p>
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 px-2 gap-4">
      <a href="gregarious-dragon-a4fbcc.netlify.app/?" className="flex items-center text-purple-400 hover:underline">
        Go Live
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M6 6a.75.75 0 01.75-.75h6.5a.75.75 0 01.75.75v6.5a.75.75 0 11-1.5 0V6.56L4.72 14.78a.75.75 0 11-1.06-1.06L11.44 6H6z" clipRule="evenodd" />
        </svg>
      ...
      <a href="https://github.com/rotshidzw/landingpage" className="flex items-center text-purple-400 hover:underline">
        Git code
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M6 6a.75.75 0 01.75-.75h6.5a.75.75 0 01.75.75v6.5a.75.75 0 11-1.5 0V6.56L4.72 14.78a.75.75 0 11-1.06-1.06L11.44 6H6z" clipRule="evenodd" />
        </svg>
 ...
 {/* eslint-disable no-alert, no-console */}
    ...
    <div className="p-4">
      ...
      <p className="text-white mb-4 text-md font-extralight">shows off his youtube videos and his playlist its done by using googleapi to show all the info the rapper antidamanace including the functioning contact form furthermore the about which include who he is</p>
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 px-2 gap-4">
      <a href="https://antidamenace.netlify.app/" className="flex items-center text-purple-400 hover:underline">
        Go Live
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M6 6a.75.75 0 01.75-.75h6.5a.75.75 0 01.75.75v6.5a.75.75 0 11-1.5 0V6.56L4.72 14.78a.75.75 0 11-1.06-1.06L11.44 6H6z" clipRule="evenodd" />
        </svg>
      ...
      <a href="https://github.com/rotshidzw/nextjsapi" className="flex items-center text-purple-400 hover:underline">
        Git code
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M6 6a.75.75 0 01.75-.75h6.5a.75.75 0 01.75.75v6.5a.75.75 0 11-1.5 0V6.56L4.72 14.78a.75.75 0 11-1.06-1.06L11.44 6H6z" clipRule="evenodd" />
        </svg>
        ...
        {cards.slice(0, showMore ? cards.length : 6).map((card, index) => (
         ...
         {/* eslint-disable no-alert, no-console */}
            ...
            <div className="p-4">
              ...
              <p className="text-white mb-4 text-md font-extralight">{card.description}</p>
              <a
                href={card.link}
...
<div className="flex  justify-center items-center ">
      <div className="flex mt-12 justify-center items-center h-[100px] w-[100px] md:h-32 md:w-32 text-white border-2   hover:text-black hover:bg-black rounded-full bg-black cursor-pointer">
